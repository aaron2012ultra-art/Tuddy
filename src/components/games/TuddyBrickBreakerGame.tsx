                  ...
                  if (b.isCorrect) {
                    ...
                    setBallsLeft((l) => {
                      ...
                      if (nl <= 0) {
                        ...
                        setFeedback(
                          `¡Bóveda incorrecta! Rompiste [${b.letter}]: "${b.optionText}". La respuesta correcta era "${currentRound.correctAnswer}". ${currentRound.explanation}`
                        );
                      } else {
  ...
  return (
    <div className="bg-slate-900 rounded-3xl p-4 sm:p-6 text-white max-w-5xl mx-auto shadow-2xl border-4 border-amber-500/30 flex flex-col gap-4 select-none">
      ...
      >
        ...
        {feedback && (gameState === "playing" || gameState === "ready") && (
